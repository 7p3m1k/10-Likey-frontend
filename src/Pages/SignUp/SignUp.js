            ...
            <div className="signUpWarp">
              ...
              <div className="signUpFooter">
                ...
                <div className="inputArea">
                  ...
                  <span
                    className={`noneValue ${
                      this.state.password !== null ? "value" : ""
                    }`}
                  >
                    필수 입력 항목입니다.
                  </span>
                  <input
                    className={`inputLow ${
                      this.state.passwordCheck !== null ? "value" : ""
                    }`}
                    name="passwordCheck"
                ...
                <p>
                  ...
                  <label for="1-input-checkbox">
                    [필수] 약관에 동의 합니다.
                  </label>
                </p>
                <img
                  className="twoDragon"
                  src="/Images/SignUp/twodragon2.png"
                />
                <p>
                ...
                <img
                  className="twoDragon"
                  src="/Images/SignUp/twodragon3.png"
                />
                <p>
                  <input
                    type="checkbox"
                ...
                <div className={check === false ? "none" : "selectionHide"}>
                  <div className="orLine">
